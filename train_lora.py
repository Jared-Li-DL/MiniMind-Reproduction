...
def init_model(lm_config):
    ...
    checkpoint_dir = './out' # Assuming the default path structure
    os.makedirs(checkpoint_dir, exist_ok=True) # Add this line

    tokenizer = AutoTokenizer.from_pretrained('./model/minimind_tokenizer')
    model = MiniMindLM(lm_config)
    ckp = f'{checkpoint_dir}/rlhf_{lm_config.dim}{moe_path}.pth' # Use the variable
    try:
        state_dict = torch.load(ckp, map_location=args.device)
        model.load_state_dict(state_dict, strict=False)
    except FileNotFoundError:
        print(f"Error: Checkpoint file not found at {ckp}")
        print("Please ensure the base model checkpoint exists.")
        print("This file might be generated by a pre-training or full SFT script, or needs to be placed manually.")
